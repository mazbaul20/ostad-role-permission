...
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            <div class="btn-group">
                <a href="product-index.html" class="btn btn-primary">All Product</a>
            </div>
        </div>
    </div>
    <!--end breadcrumb-->
                    ...
                    <form action="{{ route('products.store') }}" method="post">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                ...
                                @enderror" id="name" name="name" value=""
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                ...
                                @enderror" id="price" name="price" value=""
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                ...
                                @enderror" id="quantity" name="quantity" value=""
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                ...
                                @enderror" id="description" name="description" rows="3" placeholder="description"></textarea>
                                @error('description')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
